...
type ClusterOrder struct {
	...
	xxx_hidden_Spec     *ClusterOrderSpec      `protobuf:"bytes,3,opt,name=spec,proto3"`
	xxx_hidden_Status   *ClusterOrderStatus    `protobuf:"bytes,4,opt,name=status,proto3"`
...
type ClusterOrderSpec struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TemplateId         string                 `protobuf:"bytes,1,opt,name=template_id,json=templateId,proto3"`
...
type ClusterOrderCondition struct {
	state                         protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Type               ClusterOrderConditionType `protobuf:"varint,1,opt,name=type,proto3,enum=fulfillment.v1.ClusterOrderConditionType"`
