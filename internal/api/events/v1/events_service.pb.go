...
func (*EventsWatchRequest) Descriptor() ([]byte, []int) {
	return file_events_v1_events_service_proto_rawDescGZIP(), []int{0}
}
...
func (*EventsWatchResponse) Descriptor() ([]byte, []int) {
	return file_events_v1_events_service_proto_rawDescGZIP(), []int{1}
}
...
var (
	file_events_v1_events_service_proto_rawDescOnce sync.Once
	file_events_v1_events_service_proto_rawDescData []byte
)

func file_events_v1_events_service_proto_rawDescGZIP() []byte {
	file_events_v1_events_service_proto_rawDescOnce.Do(func() {
		file_events_v1_events_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_events_v1_events_service_proto_rawDesc), len(file_events_v1_events_service_proto_rawDesc)))
	})
	return file_events_v1_events_service_proto_rawDescData
}
