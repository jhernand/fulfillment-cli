...
func (s *cmdTokenSource) Token() (result *oauth2.Token, err error) {
...
func (s *cmdTokenSource) generateToken() (result string, err error) {
...
func (s *cmdTokenSource) parseToken(tokenText string) (result *oauth2.Token, err error) {
